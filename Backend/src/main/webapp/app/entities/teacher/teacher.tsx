  ...
  return (
    <div>
      <h2 id="teacher-heading" data-cy="TeacherHeading">
        <Translate contentKey="backendApp.teacher.home.title">Teachers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="backendApp.teacher.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/teacher/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="backendApp.teacher.home.createLabel">Create new Teacher</Translate>
          </Link>
        </div>
      </h2>
        ...
        {teacherList && teacherList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="backendApp.teacher.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('cin')}>
                  <Translate contentKey="backendApp.teacher.cin">Cin</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('cin')} />
                </th>
                <th className="hand" onClick={sort('numTeacher')}>
                  <Translate contentKey="backendApp.teacher.numTeacher">Num Teacher</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('numTeacher')} />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/teacher/${teacher.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="backendApp.teacher.home.notFound">No Teachers found</Translate>
            </div>
          )
        )}
      </div>
