  ...
  return (
    <div>
      <h2 id="student-heading" data-cy="StudentHeading">
        <Translate contentKey="backendApp.student.home.title">Students</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="backendApp.student.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/student/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="backendApp.student.home.createLabel">Create new Student</Translate>
          </Link>
        </div>
      </h2>
        ...
        {studentList && studentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="backendApp.student.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('cin')}>
                  <Translate contentKey="backendApp.student.cin">Cin</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('cin')} />
                </th>
                <th className="hand" onClick={sort('numCarteEtud')}>
                  <Translate contentKey="backendApp.student.numCarteEtud">Num Carte Etud</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('numCarteEtud')} />
                </th>
                ...
                <th className="hand" onClick={sort('classId')}>
                  <Translate contentKey="backendApp.student.classId">Class Id</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('classId')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="backendApp.student.home.notFound">No Students found</Translate>
            </div>
          )
        )}
      </div>
