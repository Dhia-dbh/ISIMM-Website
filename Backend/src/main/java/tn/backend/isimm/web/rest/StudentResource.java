...
import tn.backend.isimm.repository.StudentRepository;
import tn.backend.isimm.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link tn.backend.isimm.domain.Student}.
 */
@RestController
    ...
    public ResponseEntity<Student> partialUpdateStudent(
        ...
        Optional<Student> result = studentRepository
            ...
            .map(existingStudent -> {
                ...
                if (student.getNumCarteEtud() != null) {
                    existingStudent.setNumCarteEtud(student.getNumCarteEtud());
                }
