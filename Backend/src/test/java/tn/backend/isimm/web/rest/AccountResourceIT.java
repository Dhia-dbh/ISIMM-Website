...
import tn.backend.isimm.IntegrationTest;
import tn.backend.isimm.config.Constants;
import tn.backend.isimm.domain.User;
import tn.backend.isimm.repository.AuthorityRepository;
...
import tn.backend.isimm.service.dto.PasswordChangeDTO;
import tn.backend.isimm.web.rest.vm.KeyAndPasswordVM;
import tn.backend.isimm.web.rest.vm.ManagedUserVM;
