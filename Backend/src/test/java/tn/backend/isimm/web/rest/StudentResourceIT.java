...
import static tn.backend.isimm.domain.StudentAsserts.*;
import static tn.backend.isimm.web.rest.TestUtil.createUpdateProxyForBean;
...
class StudentResourceIT {
    ...
    private static final String DEFAULT_CIN = "14019481";
    private static final String UPDATED_CIN = "26517979";

    private static final String DEFAULT_NUM_CARTE_ETUD = "AAAAAAAAAA";
    private static final String UPDATED_NUM_CARTE_ETUD = "BBBBBBBBBB";
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            .cin(DEFAULT_CIN)
            .numCarteEtud(DEFAULT_NUM_CARTE_ETUD)
            .email(DEFAULT_EMAIL)
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student()
            .cin(UPDATED_CIN)
            .numCarteEtud(UPDATED_NUM_CARTE_ETUD)
            .email(UPDATED_EMAIL)
    ...
    @Test
    @Transactional
    void checkNumCarteEtudIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        student.setNumCarteEtud(null);
    ...
    void getAllStudents() throws Exception {
        ...
        restStudentMockMvc
            ...
            .andExpect(jsonPath("$.[*].numCarteEtud").value(hasItem(DEFAULT_NUM_CARTE_ETUD)))
    ...
    void getStudent() throws Exception {
        ...
        restStudentMockMvc
            ...
            .andExpect(jsonPath("$.numCarteEtud").value(DEFAULT_NUM_CARTE_ETUD))
