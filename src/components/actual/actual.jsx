...
function Actual(){
    const[N,SetN] = useState([{Title: "Notes" ,Describtion:"Grades are now available" ,Link:"to releve des notes" ,Date:"12/10/2025" } ,
     {Title: "Calendrier des Examan" ,Describtion:"Exams Chalender are now available" ,Link:"to Exam",Date:"12/10/2025" },
     {Title: "Inscription" ,Describtion:"Notes about inscription" ,Link:"to PDF",Date:"12/10/2025" },
     {Title: "Rattrapage" ,Describtion:"Mr.Lazher rattrage de 16:00->18:00" ,Link:"Link to PDF DOC ",Date:"12/10/2025" },
     {Title: "Emploi du temps" ,Describtion:"Eploi du temp" ,Link:"to emploi page",Date:"12/10/2025" }  ,
     {Title: "Event" ,Describtion:"DevFest Monastir" ,Link:"to formulaire about details or pdf",Date:"12/10/2025" },
     {Title: "Exchange program" ,Describtion:"Exchange program nigiria" ,Link:"formulaire or doc",Date:"12/10/2025" },
     {Title: "notification" ,Describtion:"Absence collective :). Cry about it ;) + te7chelkom" ,Link:"formulaire or doc",Date:"12/10/2025" }    ])
